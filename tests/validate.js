...
assert.equal((indexMarkup.match(/assets\/brand\/twin-beans-logo\.svg/g) || []).length, 2);
...
assert.match(indexMarkup, /id="send-intake-btn"/);
...
assert.match(rawAppSource, /id="send-quiz-btn"/);
